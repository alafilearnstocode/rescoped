...
export default function Demo() {
  ...
  const createDemoData = useMutation(api.companies.createDemoData);
  ...
  useEffect(() => {
      ...
      if (!demoInitialized) {
        try {
          ...
          if (result.companiesCreated > 0) {
            toast(`Demo loaded! Viewing ${result.totalCompanies} companies.`);
          }
          setDemoInitialized(true);
        } catch (error) {
          console.error("Failed to initialize demo:", error);
          toast("Demo data loaded from existing companies.");
          setDemoInitialized(true);
        }
      }
    };
    ...
    initializeDemo();
  }, [createDemoData, demoInitialized]);
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Explore our demo with 10 sample companies across 5 industries
              </p>
            </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-sm">
                  ...
                  <Link to="/auth" className="text-primary hover:underline ml-1">
                    Sign up to add your own companies and save your analysis.
                  </Link>
                </p>
              </div>
            </CardContent>
